 ...
 * Extensión de SPEC-034 (mover bloque Grabación a la top bar): durante la
 * grabación la sesión en vivo — cronómetro, Detener, badge de estado y
 * medidores — también vive en la top bar (topbar-recording-controls) y la
 * sección «Grabación» desaparece del final de la página mientras se graba.
