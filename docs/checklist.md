...
- [ ] 🔴 Prueba de captura simultánea de **micrófono + altavoces/salida del sistema** en macOS (RF-AUDIO-002)
- [ ] 🔴 Gestión de **permisos** de micrófono y captura de audio de sistema en macOS (RF-AUDIO-005)
...
- [ ] 🔴 Scaffolding **Electron + React + TypeScript** empaquetable en macOS (RF-APP-001)
...
- [ ] 🔴 **Crear discovery** por nombre (como carpeta contenedora) (RF-DISC-001)
- [ ] 🟡 Renombrar / listar / eliminar discoveries (RF-DISC-002)
