# SPEC-059 — Plan de implementación

> Plan a partir de `specs/SPEC-059-desacoplar-asistente-guion.md` (issue #38). Toca main, preload, tipos y renderer. Sin cambios de persistencia (`db.json` intacto): las ventanas desacopladas son efímeras por sesión de grabación.
